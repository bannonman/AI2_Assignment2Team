...
def main():
    ...
    cat = open("solution/c11342611+C11343056.txt", 'w')
    cat.close()
    ...
    def categorical(i):
        ...
        cat_str = "%s,%s,%s,%s,%s,%s,%s,%s,%s \n" % (str(count1),str(round(miss,2)),
        ...
        # Open a file
        cat = open("solution/c11342611+C11343056.txt", "a")
    ...
    def continuous(i):
        ...
        # Open a file
        con = open("solution/c11342611+C11343056.txt", "a")
    ...
    con = open("solution/c11342611+C11343056.txt", 'a')
    con.write("id, Elevation, Aspect, Slope, Horizontal_Distance_To_Hydrology, Vertical_Distance_To_Hydrology, Horizontal_Distance_To_Roadways, Hillshade_9am, Hillshade_Noon, Hillshade_3pm, Horizontal_Distance_To_Fire_Points, Wilderness_Area, Soil_Type, Target Feature\n")
    con.close()
